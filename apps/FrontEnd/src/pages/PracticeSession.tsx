...
import { fetchQuestion, saveProgress, QuestionResponse } from '../lib/api';
...
export const PracticeSession = () => {
    ...
    useEffect(() => {
        const loadQuestion = async () => {
            ...
            setError(null);
            try {
                const data = await fetchQuestion(chapterId, mode, paramQuestionId);
        ...
        loadQuestion();
    }, [chapterId, mode, paramQuestionId]);
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-200 dark:border-indigo-900/50 overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-slate-50 to-white dark:from-slate-800 dark:to-slate-800/50 border-b border-gray-200 dark:border-indigo-900/50">
                        <QuestionView question={{
                            question_id: questionData.questionRef || questionData.questionId, // Use Ref if available
