...
3. **Extract ALL questions** - Don't miss any
4. **Preserve exact question numbering** - Use what's printed (8.1, 8.2, etc.)
5. **Convert ALL math to LaTeX** - Including chemical formulas
6. **Accurately flag figures** - This determines if Pass 2 is needed
